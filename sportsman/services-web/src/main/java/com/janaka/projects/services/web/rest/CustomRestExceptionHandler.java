...
import com.janaka.projects.dtos.exceptions.InvalidJwtTokenException;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected CustomResponseEntity<ApiResponseObject<?>> handleExceptionInternal(Exception exception,
      HttpStatus httpStatus, WebRequest request, String error) {
  ...
  protected CustomResponseEntity<ApiResponseObject<?>> handleExceptionInternal(Exception exception,
      HttpStatus httpStatus, WebRequest request, List<String> errors) {
    if (HttpStatus.INTERNAL_SERVER_ERROR.equals(httpStatus)) {
      request.setAttribute(WebUtils.ERROR_EXCEPTION_ATTRIBUTE, exception, WebRequest.SCOPE_REQUEST);
    }
  ...
  public CustomResponseEntity<ApiResponseObject<?>> handleConstraintViolation(
