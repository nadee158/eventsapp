...
define(['app'], function (app) {
  ...
  app.controller('ListGradeBeltController', ['$scope','$compile','$rootScope','$location','$filter', 'DTOptionsBuilder','DTColumnBuilder', 
                                               'CommonStorageFactory','NotificationServiceFactory','PubSub','Constants','Page',
                                               'ModalDialogServiceFactory','GradeBeltServiceFactory','CommonServiceFactory',
	  ...
	  Page.setTitle('List Grade Belts');
      ...
      vm.dtOptions = DTOptionsBuilder.newOptions()
       .withOption('ajax', {
           url: baseUrl + '/gradebeltservice/getall',
           type: 'POST',
           data: function ( d ) {
      ...
      vm.dtColumns = [
          DTColumnBuilder.newColumn('gradeBeltName').withTitle('Grade Belt Name'),//0
      ...
      $scope.edit = function(id) {
          $location.path('/editgradebelt').search({id: id});
      };
      ...
      function deleteRecord(objectDeletionRequest) {
    	  ...
    	  var response=GradeBeltServiceFactory.deleteGradeBelt(objectDeletionRequest,baseUrl);		         
